			...
			<div class="frame-story" id="main-story">
						...
						<div class="info">
							<div class="name">
								<div class="pos-story">
									...
									<div class="date">Joined on {{ date('F d, Y', strtotime($story->created)) }}</div>
								</div>
							</div>
						</div>
						<div class="tool">
				...
				<div class="pos mid">
					<div class="here-block padding-20px">
						<div class="title ctn ctn-main ctn-sans-serif">
							<?php echo $story->title; ?>
						</div>
					</div>
					<div class="content ctn ctn-main ctn-serif">
				...
				<div class="pos bot">
					...
					<div class="here padding-15px">
						<div class="ctn ctn-sans-serif">
							<strong class="ttl-main-color">Published to Story on {{ date('F d, Y h:i:sa', strtotime($story->created)) }} by {{ $story->name }}</strong>
						</div>
					</div>
					<div class="here">
						<div class="here-block">
					...
					<div class="panel-bottom fixed bdr-top" id="tool-panel">
						<div class="col-small">
							<div class="pb-place grid grid-2x">
								<div class="grid-1">
									<button class="btn btn-pad-10px btn-color-gg-3 btn-radius btn-line-40px" id="frame-loves">
					...
					<div class="loved top-comment bdr-top" id="tr-comment">
						...
						<form method="post" action="javascript:void(0)" id="comment-publish">
							<div class="comment-head bdr-bottom">
								<textarea class="cmt-1 edit-text txt-sekunder-color" id="comment-description"></textarea>
...
<div class="col-full">
	<div class="block">
		...
		<div class="need-mrg-left ttl-main-color padding-10px">
